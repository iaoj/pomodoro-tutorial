...
function momentoAcao(){
    ...
    if(sessoesValor != '1'){
        document.getElementById('title_sessao').innerHTML = sessoesValor + ' sessões restantes'
    } else {
        document.getElementById('title_sessao').innerHTML = sessoesValor + ' sessão restante'
    }
